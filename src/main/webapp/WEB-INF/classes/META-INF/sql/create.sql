create table users(id INT NOT NULL AUTO_INCREMENT, email varchar(256) not null,hash varchar(256) not null,salt varchar(256) not null,isauthenticated boolean not null,avatar varchar(256) null,PRIMARY KEY (id));
...
INSERT INTO users values(1,'shout@shout.com', 'dtb/tiAi8P0a/NGDh4LW/w==', 'CmZ8PNZlVm28PLsTKgR8pg==', false, null);